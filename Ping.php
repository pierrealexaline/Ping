...
class Ping
{
    ...
    /**
     * Ping an url with Curl.
     * 
     * @param string $site url to ping.
     * @param int $timeout max time before stop command curl in millisec.
     * @return array $this->pingR implemented with http status code (int).
     *                            & request time in millisec (int).
     * 
     */
    ...
    /**
     * Get http code text from error code (int).
     *  
     * @param int $statusCode http status code.
     * @return array $this->pingR implemented with status code (string)
     * 
     */


    public function getHttpCodeHR(int $statusCode){
        ...
        $this->pingR['httpStatusCode'] = $httpStatusCodes[trim($statusCode)]; 
        return $this->pingR;
    }
}
